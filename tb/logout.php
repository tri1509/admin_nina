<HTML>
<?php $url = "?action=logout" ; include '../lib/database.php'; ?>
...
<BODY>
  <div id="alert">
    ...
    <div class="message alert alert-success">Đổi mật khẩu thành công</div>
    <div class="rlink">(Hệ thống sẽ đăng xuất sau 5 giây)</div>
    <div class="progress">
