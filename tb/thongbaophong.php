<HTML>
<?php $url = "danh-sach-phong" ; include '../lib/database.php'; ?>

<HEAD>
  <TITLE>:: Thông Báo ::</TITLE>
  <base href="<?php echo $config['base'] ?>" />
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  <meta http-equiv="REFRESH" content="1.5; url=<?php echo $url ?>">
...
<BODY>
  <div id="alert">
    <i class="fas ti ti-circle-check fasuccess"></i>
    <div class="title">Thông báo</div>
    <div class="message alert alert-success">Cập nhật dữ liệu thành công</div>
    <div class="rlink">(<a href="<?php echo $url ?>">Click vào đây nếu không muốn đợi
        lâu</a>)</div>
    <div class="progress">
      <div id="process-bar" class="progress-bar progress-bar-striped progress-bar-success active" role="progressbar"
